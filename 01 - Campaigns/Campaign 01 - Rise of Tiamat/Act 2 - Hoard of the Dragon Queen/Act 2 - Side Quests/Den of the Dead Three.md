...
____
### PART I - Lady Ravenshade

*As you approach Raven's Arbour, the first thing you notice is its high metal fence sculpted into beautiful, thorned spikes. Behind them sits a large bush of multi-coloured roses that seem to glow intermittently. The manor itself is grand, standing at three stories tall. Its sandstone-coloured walls and glistening dark roof tiles are bathed in the light of the sun, giving it a warm glow. The façade of the house is well-maintained. Each window of this castle-like structure have beautifully hand-sculpted panes depicting corvids and florals. When your party reaches the gates, a pair of guards greet you. Both of them decorated in black half-plate and furs that sit atop their dark cloaks. One of them, a beautiful female elf with tan skin, wavy black hair, brown eyes and a stern face speaks up first.

TESSA: You approach Raven's Arbour, home of House of Ravenshade. I am Tessa Corvain. What business do you have here?

Tessa will inform the players that [[Margaret Ravenshade]] is only concerned with meeting those interested in helping her with the serial killings in [[Baldur's Gate]]. If the players attempt to gain entry any other way, they will be rejected outright. Upon informing Tessa that the players have information regarding the Bhaalists in the city, she will go inside and inform [[Margaret Ravenshade]]. In the mean time, the party will be left behind with the other guard, a half-orc by the name of Uruk.
...
MARG: I've been informed you have information for me. You have about thirty seconds to convince me to continue this conversation.

If the players give her sufficient information, she will invite them inside. Tessa will follow them in while Uruk remains outside.

*Following after Lady Ravenshade, her and Tessa lead you through the interior of Raven's Arbour. The inside is far larger than what you could've imagined, nearly rivalling the interior of  Twilight Hall in Berdusk. The ceilings must be at least 15 feet high, and beautiful wallpaper cover the walls. You spot half a dozen paintings of what you can only assume are Lady Ravenshade's ancestors.  Their eyes seem to follow you as you walk down the large, carpeted hallway. On your way to wherever she may be leading you, you manage to get a peak through a few rooms, each look to be equally as beautifully decorated as the other. 
...
*You approach the location Lady Ravenshade described to you. The bathhouse itself is this one-story stuccoed building with stained glass windows and clay roof tiles. A large ten foot tall wall encloses a large courtyard outside the southeast corner of the building. The wood doors to the courtyard look exactly as she described; images of smiling nymphs dancing and frolicking in water.*
...
From dawn to midnight, characters can expect to find 1d6 human [commoners](https://5e.tools/bestiary.html#commoner_mm) bathing here at any given time. From midnight to dawn, three female human [night blades](https://5e.tools/bestiary.html#night%20blade_bgdia) stand guard near the pools and attack trespassers on sight. If a fight breaks out here, a Necromite of Myrkul attacks the party along with a Reaper of Bhaal. The Zhent of Bane in D4 will also be alerted by the noise and join the fray.
...
From midnight to dawn, a male human Zhent of Bane guards this room unless he's drawn to [area D2](https://5e.tools/adventure.html#bgdia,1,d2.%20baths,0) by sounds of battle there. During the hours in which the bathhouse is open, a female human masseuse (neutral good [commoner](https://5e.tools/bestiary.html#commoner_mm)) named Qurmilah works here. She knows the same information as Jabaz in area D3 and behaves similarly.

This room is furnished in the same fashion as area D3, with the additional feature of a secret door in the north wall. A character who searches the north wall and succeeds on a DC 10 Wisdom (Perception) check finds the secret door, which swings inward when pushed. A foul, sewer-like stench greets anyone who opens the secret door. Behind the door, a staircase descends 20 feet to [area D5](https://5e.tools/adventure.html#bgdia,1,d5.%20welcome%20to%20the%20dungeon,0), featuring smooth stone steps and brick walls. Two sputtering torches in wall sconces illuminate the staircase, but the dungeon below is dark.

Upon killing the Zhent of Bane, the following note can be found on their person.

	`Vanthampur's secret must not be found.` 
	`Keep away any prying eyes.` 
	`The Serpent is on our tail.` 
	`Alert us at the first sign of trouble.`
...
- Certain areas of the dungeon (as shown on [map 1.3](https://5e.tools/adventure.html#bgdia,1,map%201.3%3a%20dungeon%20of%20the%20dead%20three,0)) are flooded with murky water to a depth of 2 feet to make them [difficult terrain](https://5e.tools/quickreference.html#bookref-quick,3,difficult%20terrain). The water seeps into the dungeon from nearby sewers through cracks in the limestone. It carries a foul stench and is undrinkable.
...
The corpse was once a Bhaal worshiper named Hiskaal, who was killed by his cultist peers for allowing a target to escape during a recent attack in the city. Any character who inspects the corpse and succeeds on a DC 10 Wisdom (Medicine) check concludes that the man has been dead for two days.
...
The humanoid entrails were left on the altar as an offering to the god of murder. Pouring a [vial of holy water](https://5e.tools/items.html#holy%20water%20\(flask\)_phb) on the entrails causes them to melt away and also causes the altar to smolder.
...
*This chamber is empty but not bereft of decor. Carved into each of its three doors is a full-figure depiction of one what appears to be a different figure each.* 

A character recognizes all the figures with a successful DC 10 Intelligence (Religion) check.
...
These three [necromites of Myrkul](https://5e.tools/bestiary.html#necromite%20of%20myrkul_bgdia) are playing dead. They conceal their skull-headed flails underneath their robes. Any character who watches the bodies carefully can determine that they're alive with a successful DC 10 Wisdom (Insight) check.
...
Spellbook 1 is bound in red leather and contains the following spells: [burning hands](https://5e.tools/spells.html#burning%20hands_phb), [detect magic](https://5e.tools/spells.html#detect%20magic_phb), [disguise self](https://5e.tools/spells.html#disguise%20self_phb), [fog cloud](https://5e.tools/spells.html#fog%20cloud_phb), [ray of sickness](https://5e.tools/spells.html#ray%20of%20sickness_phb), [silent image](https://5e.tools/spells.html#silent%20image_phb).

Spellbook 2 has the personal rune of its previous owner burned into its umber cover. This book contains the following spells: [charm person](https://5e.tools/spells.html#charm%20person_phb), [find familiar](https://5e.tools/spells.html#find%20familiar_phb), [identify](https://5e.tools/spells.html#identify_phb), [magic missile](https://5e.tools/spells.html#magic%20missile_phb), [sleep](https://5e.tools/spells.html#sleep_phb).

Spellbook 3 is bound in scaly black reptile hide and contains the following spells: [cloud of daggers](https://5e.tools/spells.html#cloud%20of%20daggers_phb), [darkvision](https://5e.tools/spells.html#darkvision_phb), [detect magic](https://5e.tools/spells.html#detect%20magic_phb), [feather fall](https://5e.tools/spells.html#feather%20fall_phb), [mage armor](https://5e.tools/spells.html#mage%20armor_phb), [magic missile](https://5e.tools/spells.html#magic%20missile_phb), [Tasha's hideous laughter](https://5e.tools/spells.html#tasha's%20hideous%20laughter_phb).
...
This flooded tunnel has a secret door in the north wall that swings open into [area D27](https://5e.tools/adventure.html#bgdia,1,d27.%20echoes%20of%20battle,0). Standing in the water south of the secret door, holding a lit torch and watching the west stairway, is a male [fist of Bane](https://5e.tools/bestiary.html#fist%20of%20bane_bgdia). On his first turn after seeing the characters, he withdraws to [area D25](https://5e.tools/adventure.html#bgdia,1,d25.%20bane's%20rest,0) and pounds on the door to wake his fellow cultists, yelling "Intruders!" at the top of his lungs to alert the occupant of [area D26](https://5e.tools/adventure.html#bgdia,1,d26.%20bhaal's%20rest,0).
...
Slumped against the walls of this plundered, partially collapsed crypt are four sleeping [fists of Bane](https://5e.tools/bestiary.html#fist%20of%20bane_bgdia). All are fully armored and have their weapons nearby. If awakened by loud noises or the guard in [area D23](https://5e.tools/adventure.html#bgdia,1,d23.%20secret%20door%20and%20sentry,0), they grab their weapons and quickly mobilize to repel any intrusion.
...
Bhaal worshipers like to bathe in the human blood that fills the sarcophagus. A female [reaper of Bhaal](https://5e.tools/bestiary.html#reaper%20of%20bhaal_bgdia) lurks behind the sarcophagus, drenched in blood from head to toe. At the first sign of intruders, she uses a [disguise self](https://5e.tools/spells.html#disguise%20self_phb) spell to appear as a frail old woman named Nebra. In this guise, she claims to be a florist who was captured by the Dead Three and brought to the dungeon as a slave. If the characters fall for the act and bring Nebra with them, she claims to know the location of a secret door ([area D23](https://5e.tools/adventure.html#bgdia,1,d23.%20secret%20door%20and%20sentry,0)) and tries to lead them through it to [area D29](https://5e.tools/adventure.html#bgdia,1,d29.%20mortlock%20vanthampur,0), where she hopes to find reinforcements. If she leads the party to a location occupied by other cultists, she drops the disguise and attacks. She also attacks if her spell ends before then.

##### D27. Echoes of Battle

This ten-foot-wide flooded passage is braced at regular intervals by wooden beams. Old torch stubs float on the murky water. At the point where the tunnel bends west toward [area D29](https://5e.tools/adventure.html#bgdia,1,d29.%20mortlock%20vanthampur,0), the characters hear echoes of a battle unfolding in that location.

##### D28. Old Cellar

This flooded room was once a cellar, with the collapsed eastern passage marking a staircase that formerly led up to a residence in the city. Hidden under the murky water are four animated human [skeletons](https://5e.tools/bestiary.html#skeleton_mm) that rise up and attack anyone who crosses the room.
...
A short flight of stairs climbs to a circular chamber with four padlocked wooden chests piled in the middle of it. The chests are locked, but characters might have wrested the keys from the iron consul in [area D12](https://5e.tools/adventure.html#bgdia,1,d12.%20bane's%20altar,0). A character can also use [thieves' tools](https://5e.tools/items.html#thieves'%20tools_phb) to pick a padlock with a successful DC 15 Dexterity check.

Treasure. Each chest weighs 25 pounds empty, and all four contain loot stolen from Tiamat's hoard on Avernus. This treasure was brought to Baldur's Gate by devils in league with Zariel, and was given to the Dead Three cultists by [Amrik Vanthampur](https://5e.tools/bestiary.html#amrik%20vanthampur_bgdia) on behalf of his mother, [Duke Thalamra Vanthampur](https://5e.tools/bestiary.html#duke%20thalamra%20vanthampur_bgdia). The contents of each chest are described below.

Chest 1 holds 4,500 cp and two red crystal vials with gold stoppers (25 gp each). Each vial contains a [potion of fire breath](https://5e.tools/items.html#potion%20of%20fire%20breath_dmg). With the coins and vials inside, the chest weighs 70 pounds.
...
Nine wooden crates are scattered throughout this room. Scurrying among them are six harmless [rats](https://5e.tools/bestiary.html#rat_mm) like the one encountered in [area D14](https://5e.tools/adventure.html#bgdia,1,d14.%20hungry%20rat,0).
